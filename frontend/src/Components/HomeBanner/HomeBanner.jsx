    ...
    return (
        <div style={{backgroundImage: "url('../../../Images/homepage_bg.jpg')"}} className="bg-cover text-white">
            <div  className="bg-black bg-opacity-50 text-opacity-100 w-full h-screen mx-auto text-center flex flex-col justify-center">
                <h1 className="md:text-5xl sm:text-4xl text-2xl text-[#6ce7ae] p-2">Grow with Travellista</h1>
                <div className="flex justify-center">
                    <p className="font-bold md:text-2xl sm:text-lg text-sm">U can't buy Happiness,But</p>
                    <Typed className="font-bold md:text-2xl sm:text-lg text-sm pl-2 sm:block hidden" strings={['U can buy a Ticket from Travellista...']} loop typeSpeed={80} backSpeed={140} />
                </div>
                <div className="pt-5 ">
